...
//  }
  ...
  public static class ElevatorConstants {
    ...
    public static final double REEF_L2_POSE = 3.0;
    public static final double REEF_L3_POSE = 11.0;
  ...
  public static class CoralConstants {
    ...
    public static double CORAL_L4 = 165.0; // was 287.5
    public static double CORAL_L2_L3 = 155.0;
    ...
    public static double CORAL_SLIDER_RIGHT_POSITION = -0.5;
