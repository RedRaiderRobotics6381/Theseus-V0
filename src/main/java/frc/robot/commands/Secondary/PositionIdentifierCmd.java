...
//     private final AlgaeRotateSubsystem rotateSubsystem;
...
//      */
//     public PositionIdentifierCmd(ElevatorSubsystem elevatorSubsystem, AlgaeRotateSubsystem rotateSubsystem, AlgaeIntakeSubsystem intakeSubsystem, DoubleSupplier oX, DoubleSupplier oY){
...
//             Commands.race(
//                 rotateSubsystem.RotatePosCmd(Constants.ElevatorConstants.ALGAE_INTAKE_POS), // 240 degrees
...
//                 rotateSubsystem.RotatePosCmd(Constants.ElevatorConstants.REEF_MIDDLE_POSE), // 165 degrees
//                 intakeSubsystem.RunIntakeCmd(0.1))) // 10% speed of ~5600 RPM
//             .schedule();
//             // pose = Constants.ElevatorConstants.ALGAE_PICKUP_HIGH_POSE;
//             // rotatePose = Constants.ElevatorConstants.ALGAE_INTAKE_POS;
...
//                 rotateSubsystem.RotatePosCmd(Constants.ElevatorConstants.REEF_HIGH_POSE), // 150 degrees
//                 elevatorSubsystem.ElevatorHeightCmd(Constants.ElevatorConstants.REEF_HIGH_POSE + 0.5), // 15.4 inches
//                 rotateSubsystem.RotatePosCmd(Constants.ElevatorConstants.ALGAE_PICKUP_HIGH_POSE), // 240 degrees
...
//                 rotateSubsystem.RotatePosCmd(Constants.), // 240 degrees
//                 elevatorSubsystem.ElevatorHeightCmd(Constants.ElevatorConstants.HUMAN_PLAYER_POSE)) // 0.0 inches
//             .schedule();
//             // pose = Constants.ElevatorConstants.REEF_MIDDLE_POSE;
//             // rotatePose = Constants.ElevatorConstants.CORAL_MID_POS;
...
//                 rotateSubsystem.RotatePosCmd(Constants.ElevatorConstants.CORAL_MID_POS + 7.5), // 172.5 degrees
